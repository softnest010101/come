// 📁 src/components/widgets/WidgetEditForm.tsx
...
export default function WidgetEditForm({ id, initialData }: WidgetEditFormProps) {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (selectedPageIds.length > 0) {
        await api.post(`/widgets/${id}/bulk-link`, {
          targetModel: "page",
      ...
      const message = axiosErr.response?.data?.message ?? "❌ Failed to update widget";
      toast.error(message);
