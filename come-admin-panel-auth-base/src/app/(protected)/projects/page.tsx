...
export default function ProjectsPage() {
  ...
  }, [projects, search, sortAsc, visibleOnly]);
  ...
  return (
    <div className="min-h-screen bg-[#fdfaf4] px-6 py-8 font-sans text-[#3e3e3e]">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-serif font-bold text-[#5b4636]">📁 Projects</h1>
      </div>
      ...
      <div className="bg-white border border-[#dfcbb9] rounded-md overflow-x-auto shadow-md">
        {loading ? (
          <p className="p-4 text-center italic text-[#8b7b6b]">Loading projects...</p>
        ) : (
          <ProjectList projects={paginatedProjects} onDelete={handleDelete} />
        )}
      </div>
